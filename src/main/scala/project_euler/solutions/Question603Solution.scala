...
object Question603Solution extends Solution {

  override def questionNumber : Int = 603

  override def questionTitle : String = "Substring sums of prime concatenations"
